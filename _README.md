...
```bash
aws-multi-step-workflow-sample$ sam build --use-container
```
...
```bash
aws-multi-step-workflow-sample$ sam logs -n StockCheckerFunction --stack-name "aws-multi-step-workflow-sample" --tail
```
...
```bash
aws-multi-step-workflow-sample$ pip install -r tests/requirements.txt --user
# unit test
aws-multi-step-workflow-sample$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
aws-multi-step-workflow-sample$ AWS_SAM_STACK_NAME="aws-multi-step-workflow-sample" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "aws-multi-step-workflow-sample"
```
